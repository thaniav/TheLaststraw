                             ...
                             DropdownMenuItem(
                               child:  Column(
                                 ...
                                 children: <Widget>[
                                   ...
                                   Text('Get 10% off on purchases above Rs. 100'),
                                 ],
                               ),
                               value: '20FAB',
                             ),
                             DropdownMenuItem(
                               child: Column(
                                 ...
                                 children: <Widget>[
                                   ...
                                   Text('Get 100% Cashback on purchases upto Rs.75 '),
                                 ],
                               ),
                               value: 'PALLET75',
                             ),
                             DropdownMenuItem(
                               child: Column(
                                 ...
                                 children: <Widget>[
                                   ...
                                   Text('Get 25% discount up to Rs.125'),
                                 ],
                               ),
                               value: 'POB125',
                             ),
             ...
             ExpansionTile(
               ...
               children: <Widget>[
                 Row(
                   ...
                   children: <Widget>[
                     Text('Current Wallet balance: '+walletData.balance.toString()),
                     RaisedButton(
                         child: Text('Use'),
